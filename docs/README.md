...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-25 22:09:37 UTC<br>状态：成功</p>
</section>
...
<p>精读：《AdaptDuplex: from static to adaptive full-duplex spoken dialogue》（10.0/10）, 《A Harness for Synthesizing Diverse Naturalistic Full-Duplex Conversations》（9.0/10）</p>
<p>速读：《PUBG Ally: A Conversational Embodied Agent as an AI Teammate》（8.0/10）, 《EnSIMem: Entity-Structured Indexing for Long-Term Agent Memory》（7.0/10）, 《agentic-ger: terminology recovery in long-form speech using global context》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="AdaptDuplex: from static to adaptive full-duplex spoken dialogue">AdaptDuplex: from static to adaptive full-duplex spoken dialogue</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Harness for Synthesizing Diverse Naturalistic Full-Duplex Conversations">A Harness for Synthesizing Diverse Naturalistic Full-Duplex Conversations</span></li><li><span class="dpr-home-dashboard-paper-title" title="Controlling Backchannels in Streamable Full-duplex Models">Controlling Backchannels in Streamable Full-duplex Models</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="PUBG Ally: A Conversational Embodied Agent as an AI Teammate">PUBG Ally: A Conversational Embodied Agent as an AI Teammate</span></li><li><span class="dpr-home-dashboard-paper-title" title="EnSIMem: Entity-Structured Indexing for Long-Term Agent Memory">EnSIMem: Entity-Structured Indexing for Long-Term Agent Memory</span></li><li><span class="dpr-home-dashboard-paper-title" title="agentic-ger: terminology recovery in long-form speech using global context">agentic-ger: terminology recovery in long-form speech using global context</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">duplex-agent <strong>5</strong></span><span class="dpr-home-dashboard-tag">data-agent <strong>3</strong></span></div>
</section>
</div>
